...
select cuenta_caracter('DBA II', 'R');
###############################################CONTAR LA CANTIDAD DE VOCALES#######################################
###DBA II 2023#####
CREATE FUNCTION CUENTA_CANTIDAD_VOCALES1(cadena text)
RETURNS TEXT
BEGIN
...
select CUENTA_CANTIDAD_VOCALES1('dba ii 2023');

################################CANTIDAD DE PALABRAS########################################################
select locate('', 'rodrigo torrez de la cruz');

create function obtiene_apellidos(nombres text)
returns text
begin
